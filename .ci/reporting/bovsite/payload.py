...
def _opinion_of_value(
    ...
    def rung(label: str, rung_price: float) -> dict:
        ...
        return {
            "label": label,
            "price": rung_price,
            "price_per_unit": rung_price / units,
            "price_per_sf": rung_price / building_sf,
            "grm_current": rung_price / current["gross_scheduled_rent"],
            "grm_market": rung_price / market["gross_scheduled_rent"],
...
def _build_payload(workspace: DealWorkspace) -> dict:
    ...
    current = pricing["operations"]["current"]
    market = pricing["operations"].get("proforma") or pricing["operations"]["normalized"]
    ...
    property_payload = {
        ...
        "expense_per_unit": current["operating_expenses"] / units,
        ...
        "operating": {
            ...
            "expense_ratio": [current["operating_expenses"] / current_goi * 100, market["operating_expenses"] / market_goi * 100],
